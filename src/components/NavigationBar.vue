...
<template>
  <header class="mb-6 px-6 w-full flex justify-between">
    ...
    <nav class="flex">
      ...
      <a class="icon-btn mx-2" rel="noreferrer" href="https://twitter.com/luca_xue" target="_blank" title="Twitter">
        <uil-twitter-alt class="mt-1" />
      </a>
